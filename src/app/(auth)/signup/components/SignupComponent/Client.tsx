...
import { setOtpExpires, setToken, setUser } from "@/store/slices/user";
    ...
    const signup = async () => {
      ...
      try {
        ...
        if (response.data.status === "success") {
          ...
          router.push("/verify");
          sessionStorage.setItem("last-page", JSON.stringify("signup"));
        }
      } catch (error) {
        ...
        <section className="grid place-content-center py-[2vh]">
          <div className="bg-blue-100 py-[1vh] px-[2vw] rounded-lg border-2 border-blue-200 shadow-md shadow-blue-200">
            <article className="flex items-center gap-[1vw]">
              ...
              {isLoading || Boolean(thirdPartyLoginType) ? (
