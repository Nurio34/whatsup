      ...
      >
        <ul
          className=" relative isolate 
                        grid grid-cols-[repeat(3,minmax(1px,100px))] gap-x-[2vw] gap-y-[2vh]
                    "
        >
          <>
            {Array(10)
              ...
              .map((_, index) => {
                if (index < 9) {
                  return (
                    <li key={index} className="" onClick={getPositionOfAvatar}>
                      <button
                        type="button"
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        filter:
                          "blur(16px) drop-shadow(0 0 5px pink) drop-shadow(0 0 10px pink) drop-shadow(0 0 15px pink)",
                      }}
                    ></div>
                  );
                }
